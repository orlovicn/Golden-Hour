...
<div class="row">
    ...
    <div class="col-sm-8 mt-4 text-center" id="muskarci">
        <div class="page-header">
            <h1 style="text-shadow: 3px 3px orange">Muski proizvodi</h1>
        </div>
        <!--------------------- Rolex -->
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                $new = $mysqli->query("SELECT * FROM proizvodi WHERE proizvodjac ='1' AND pol = 'M'");
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                $new = $mysqli->query("SELECT * FROM proizvodi WHERE proizvodjac ='2' AND pol = 'M'");
                while($proizvodNew = $new->fetch_assoc()):
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                $new = $mysqli->query("SELECT * FROM proizvodi WHERE proizvodjac ='3' AND pol = 'M'");
                while($proizvodNew = $new->fetch_assoc()):
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                $new = $mysqli->query("SELECT * FROM proizvodi WHERE proizvodjac ='4' AND pol = 'M'");
                while($proizvodNew = $new->fetch_assoc()):
